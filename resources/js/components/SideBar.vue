<template>
    <nav :class="[' shadow-lg fixed top-0 left-0 h-full w-64 py-6 px-4 overflow-y-auto z-40 transition-transform duration-300',
                    isSidebarOpen ? 'translate-x-0' : '-translate-x-full',
                    'md:translate-x-0']" class="bg-gray-100/80">
